  ...
  return (
    <div className="flex flex-col min-h-screen bg-ivory">
      ...
      <div className="py-24 max-w-3xl mx-auto px-6 text-center">
        <h2 className="font-headline font-light text-4xl md:text-5xl text-obsidian tracking-tight leading-snug">
      ...
      <section className="bg-obsidian py-32 text-center text-ivory flex flex-col items-center">
        ...
        <h2 className="font-headline text-5xl md:text-7xl font-light tracking-tight mb-12 max-w-2xl px-6 leading-tight">
          Reserve Your Chair.
        </h2>
